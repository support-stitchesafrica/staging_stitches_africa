  ...
  if (error === "firebase-permissions") {
    return (
      <div className="p-6 space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Dashboard Setup Required</h1>
          <p className="text-gray-600 dark:text-gray-400">Firebase security rules need to be configured</p>
        </div>
        ...
        <Alert className="border-blue-200 bg-blue-50 dark:bg-blue-900/20">
          ...
          <AlertDescription className="text-blue-700 dark:text-blue-300">
            <p className="mb-3">
              Want to see how the dashboard works while setting up Firebase? Click below to load sample data and explore
              the interface.
            </p>
            <Button
        ...
        <Alert className="border-orange-200 bg-orange-50 dark:bg-orange-900/20">
          ...
          <AlertTitle className="text-orange-800 dark:text-orange-400">Firebase Security Rules Required</AlertTitle>
          <AlertDescription className="text-orange-700 dark:text-orange-300 mt-2">
            <p className="mb-4 font-medium">
              Your Firebase Firestore database is blocking access. This is normal for new Firebase projects - you just
              need to set up security rules.
            </p>

            <div className="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm mb-4 overflow-x-auto">
              <div className="flex justify-between items-center mb-2">
                <span className="text-gray-400">Firestore Security Rules</span>
                <Button
                  size="sm"
                  variant="ghost"
...
service cloud.firestore {
  match /databases/{database}/documents {
    // Allow read/write access to news collection
    match /news/{document} {
    ...
    match /news/{document} {
      allow read, write: if true;
            ...
            <div className="space-y-3">
              ...
              <div className="grid gap-3">
                <div className="flex items-start gap-3 p-3 bg-white dark:bg-gray-800 rounded-lg border">
                  <div className="flex-shrink-0 w-6 h-6 bg-rose-100 dark:bg-rose-900/20 text-rose-600 rounded-full flex items-center justify-center text-sm font-medium">
                    1
                  </div>
                  <div>
                    <p className="font-medium">Open Firebase Console</p>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Click the button below to open your Firebase project
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-white dark:bg-gray-800 rounded-lg border">
                  ...
                  <div>
                    <p className="font-medium">Navigate to Firestore Rules</p>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                ...
                <div className="flex items-start gap-3 p-3 bg-white dark:bg-gray-800 rounded-lg border">
                  ...
                  <div>
                    <p className="font-medium">Replace Rules & Publish</p>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Copy the rules above, replace the existing rules, and click <strong>Publish</strong>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-4 pt-3 border-t border-orange-200 dark:border-orange-800">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm">
                    These rules allow unrestricted access for development. For production, implement proper
                    authentication and user-based access controls.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <Button onClick={loadDashboardData} className="bg-rose-600 hover:bg-rose-700">
            <TrendingUp className="h-4 w-4 mr-2" />
            Test Connection
          </Button>
          <Button variant="outline" asChild>
            <a
              href={`https://console.firebase.google.com/project/stitches-africa/firestore/rules`}
              target="_blank"
            ...
            <CardContent>
              {recentArticles.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <Link href="/admin/news/news/create">
                    <Button className="bg-purple-600 dark:bg-purple-900 text-white dark:text-purple-400 text-sm font-medium">Create Your First Article</Button>
                  </Link>
                </div>
              ) : (
                    ...
                    >
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-600 dark:text-gray-400">
                          {article.category} • {article.createdAt.toLocaleDateString()}
                        </p>
                      </div>
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-3">
              <Link href="/admin/news/news/create">
                <Button className="bg-purple-600 w-full mb-2 dark:bg-purple-900 text-white dark:text-purple-400 text-sm font-medium">
                  <Plus className="h-4 w-4 mr-2" />
                  Create New Article
                </Button>
              </Link>
