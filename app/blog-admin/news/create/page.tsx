...
import type { CreateBlogPost } from "@/types/blog-admin"
...
function CreateNewsPageContent() {
  ...
  const handleSave = async (publish = false) => {
    ...
    try {
      ...
      router.push(`/blog-admin/news/${postId}/edit`)
    } catch (error) {
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">Write and publish your blog content</p>
          </div>
        </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">Author is automatically set to your account</p>
              </div>
              <div>
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                  <span>{formData.authorName || "Author"}</span>
                  {formData.category && (
                    <>
                      <span>•</span>
...
export default function CreateNewsPage() {
  return (
    <AuthGuard requiredPermission="create_post">
