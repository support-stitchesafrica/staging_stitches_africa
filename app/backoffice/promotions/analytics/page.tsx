/**
 * Promotions Analytics Page
 * 
 * Analytics dashboard for promotional events performance.
...
import EventAnalytics from '@/components/backoffice/promotions/EventAnalytics';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <div className="text-center max-w-md mx-auto p-6">
        ...
        <p className="text-gray-600 mb-4">You don't have permission to access promotions analytics.</p>
