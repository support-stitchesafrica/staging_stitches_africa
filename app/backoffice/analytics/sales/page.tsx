 ...
 * 
 * Detailed sales analytics dashboard showing revenue, orders,
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <div className="text-center max-w-md mx-auto p-6">
        ...
        <p className="text-gray-600 mb-4">You don't have permission to access Sales Analytics.</p>
        <button
...
function SalesAnalyticsContent() {
  ...
  return (
    <div className="p-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">
              Revenue tracking, order analysis, and sales performance metrics
            </p>
          </div>
              ...
              <tr>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500" colSpan={canWrite ? 6 : 5}>
                  <div className="text-center py-8">
                    <p className="text-gray-400">Sales data will be displayed here</p>
                    <p className="text-xs text-gray-400 mt-1">Connect to sales service to view real data</p>
                  </div>
                </td>
              </tr>
            </tbody>
      ...
      {/* Role-specific Sales Information */}
      {backOfficeUser?.role === 'bdm' && (
        <div className="mt-8 bg-green-50 rounded-xl p-6">
          <h3 className="text-lg font-semibold text-green-900 mb-2">BDM Sales Dashboard</h3>
          <p className="text-green-800 text-sm mb-4">
            As a Business Development Manager, you have write access to sales data and can manage vendor relationships.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
              <span className="text-green-800 text-sm">Manage sales data and reports</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
              <span className="text-green-800 text-sm">Access vendor management tools</span>
            </div>
          </div>
        </div>
      )}
