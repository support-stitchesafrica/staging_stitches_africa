 ...
 * 
 * Main team management dashboard for superadmins.
 * Displays team members list with overview statistics.
 * 
...
import TeamMembers from '@/components/backoffice/team/TeamMembers';
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50">
          <div className="text-center max-w-md mx-auto p-6">
            ...
            <p className="text-gray-600 mb-4">
              Team management is only available to superadmins.
            </p>
            <Link
              href="/backoffice"
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-600">
                    Manage back office users, roles, and invitations
                  </p>
                </div>
