            ...
            <DateRangeProvider>
                ...
                >
                    ...
                    {isMobile && (
                        <header className="fixed top-0 left-0 right-0 h-14 bg-white border-b border-gray-200 z-40 flex items-center px-4">
                            <button
                                ...
                                className="p-2 rounded-lg hover:bg-gray-50 transition-all duration-200 ease-out"
                            ...
                            <span className="ml-3 text-lg font-bold text-gray-900 font-ga">
                                Stitches Africa
                            </span>
                        </header>
                    )}
                    ...
                    {isMobile && isMobileMenuOpen && (
                        <div
                            className="fixed inset-0 bg-black/50 z-40 transition-ga-medium"
