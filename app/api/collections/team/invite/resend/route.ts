...
export async function POST(request: NextRequest) {
  try {
    ...
    const newInviteId = adminDb.collection("staging_collectionsInvitations").doc().id;
    ...
    await adminDb.collection("staging_collectionsInvitations").doc(newInviteId).set(newInvitation);
