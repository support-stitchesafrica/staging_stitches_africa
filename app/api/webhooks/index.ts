    ...
    <body style="font-family: Arial, sans-serif; background: #f9fafb; padding: 20px;">
      <table style="max-width:600px; margin:auto; background:white; border-radius:8px; padding:24px;">
        <tr><td style="text-align:center;">
          <img src="https://staging-stitches-africa.vercel.app/Stitches-Africa-Logo-06.png" width="120" />
        </td></tr>
        <tr><td>
          ...
          <a href="https://staging-stitches-africa.vercel.app/vendor/dashboard" style="display:inline-block; background:#000; color:white; padding:10px 20px; border-radius:8px; text-decoration:none;">
            View Dashboard
          </a>
        </td></tr>
      </table>
