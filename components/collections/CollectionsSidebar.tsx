...
export function CollectionsSidebar()
{
    ...
    const { collectionsUser, logout, hasPermission } = useCollectionsAuth();
    ...
    const getRoleInfo = () =>
    {
        if (!collectionsUser?.role) return null;
        ...
        const roleConfig = {
            ...
            editor: {
                ...
                description: 'Can create, edit, and delete collections',
            },
            viewer: {
                label: 'Viewer',
                color: 'bg-gray-600/10 text-gray-700 border-gray-200',
                description: 'Read-only access to view collections',
            },
        };

        return roleConfig[collectionsUser.role];
    };
        ...
        <>
            ...
            >
                ...
                <div className="p-4 border-b border-gray-200 flex items-center justify-between">
                    {!isCollapsed && (
                        <Link href="/collections" onClick={closeMobileSidebar} className="flex items-center gap-2">
                            <Image
                ...
                <div className="p-2 border-t border-gray-200 space-y-1">
                    {/* User Info */}
                    {!isCollapsed && collectionsUser && (
                        <div className="px-3 py-2 text-xs text-gray-600 space-y-1.5">
                            <div className="font-medium text-gray-900 truncate">
                                {collectionsUser.fullName}
                            </div>
                            <div className="truncate">{collectionsUser.email}</div>
                            {roleInfo && (
                                <div className={cn(
