/**
 * Referral Login Form Component
 * Handles user authentication for the referral program
...
export const LoginForm: React.FC<LoginFormProps> = ({ onSuccess }) => {
	...
	const { login, loading, error, clearError, isLegacyUser, completeProfile } =
		useReferralAuth();
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			const returnUrl = searchParams.get("returnUrl") || "/referral/dashboard";
	...
	const handleCompleteProfile = async (fullName: string) => {
		try {
			await completeProfile(fullName);
			// On success, redirect to dashboard or return URL
			const returnUrl = searchParams.get("returnUrl") || "/referral/dashboard";
			if (onSuccess) {
				onSuccess();
			} else {
