      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="min-w-[200px]">First Name</TableHead>
            <TableHead className="min-w-[200px]">Last Name</TableHead>
          ...
          {subscribers.length === 0 ? (
            ...
            subscribers.map((subscriber) => (
              <TableRow key={subscriber.id}>
                ...
                <TableCell className="font-medium">{subscriber.lastName}</TableCell>
