				...
				<Sidebar side="left" variant="sidebar" className="hidden md:flex">
					<SidebarHeader className="border-b px-4 lg:px-6 py-4">
						<div className="flex items-center gap-2">
							...
							<span className="text-lg font-semibold text-purple-600 hidden lg:block">
								Stitches Africa
							</span>
							<span className="text-lg font-semibold text-purple-600 lg:hidden">
