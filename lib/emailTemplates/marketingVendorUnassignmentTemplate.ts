// lib/emailTemplates/marketingVendorUnassignmentTemplate.ts
export function marketingVendorUnassignmentTemplate({
  recipientName,
  vendorName,
  vendorId,
  unassignedByName,
...
<head>
  ...
  <title>Vendor Assignment Removed</title>
  <style>
        ...
        <table class="container" width="640" style="max-width:640px; background:#ffffff; border-radius:12px; box-shadow:0 8px 30px rgba(22,28,37,0.08);">
          ...
          <tr>
            <td style="padding:32px 28px;">
              <h1 style="margin:0 0 16px 0; font-size:24px; color:#102a43;">Vendor Assignment Removed</h1>
              <p style="margin:0 0 18px 0; font-size:16px; color:#4b5563; line-height:1.6;">
                Hi ${recipientName},
              </p>
              <p style="margin:0 0 18px 0; font-size:16px; color:#4b5563; line-height:1.6;">
                ${unassignedByName} has removed a vendor assignment from you in the Marketing Dashboard.
              </p>
              ...
              <div style="background:#fef2f2; border-left:4px solid #ef4444; padding:16px; margin:24px 0; border-radius:4px;">
                ...
                <table style="width:100%; border-collapse:collapse;">
                  ...
                  <tr>
                    <td style="padding:6px 0; font-size:15px; color:#6b7280;">Removed By:</td>
                    <td style="padding:6px 0; font-size:15px; color:#102a43; font-weight:600;">${unassignedByName}</td>
                  </tr>
                  ${reason ? `
                  <tr>
                    <td style="padding:6px 0; font-size:15px; color:#6b7280; vertical-align:top;">Reason:</td>
                    <td style="padding:6px 0; font-size:15px; color:#102a43;">${reason}</td>
                  </tr>
                  ` : ''}
                </table>
              </div>
              ...
              <p style="margin:0 0 18px 0; font-size:16px; color:#4b5563; line-height:1.6;">
                This vendor is no longer assigned to you. If you have any questions about this change, please contact ${unassignedByName}.
              </p>
