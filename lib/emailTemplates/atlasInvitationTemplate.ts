// lib/emailTemplates/atlasInvitationTemplate.ts

export interface AtlasInvitationTemplateProps {
  inviteeName: string;
  inviterName: string;
  role: "superadmin" | "founder" | "sales_lead" | "brand_lead" | "logistics_lead";
...
/**
 * Email template for Atlas team member invitations
 * Following the Marketing dashboard style for consistency
 * Requirements: 11.1, 11.2, 11.3, 11.4, 11.5
 */
export function atlasInvitationTemplate({
  inviteeName,
  inviterName,
  role,
  invitationLink,
  ...
  const roleDescriptions: Record<string, string> = {
    superadmin: "Full access to all Atlas features and team management",
    founder: "Executive-level access to all analytics and insights",
    sales_lead: "Access to sales analytics and vendor performance metrics",
    brand_lead: "Access to brand analytics and marketing performance",
    logistics_lead: "Access to logistics analytics and delivery metrics",
  };

  const roleDescription = roleDescriptions[role] || "Access to Atlas dashboard";
...
<head>
  ...
  <title>You're Invited to Join Stitches Africa Atlas</title>
  <style>
        ...
        <table class="container" width="640" style="max-width:640px; background:#ffffff; border-radius:12px; box-shadow:0 8px 30px rgba(22,28,37,0.08);">
          ...
          <tr>
            <td style="padding:32px 28px;">
              <h1 style="margin:0 0 16px 0; font-size:24px; color:#102a43;">You're Invited to Join Stitches Africa Atlas! 🎉</h1>
              <p style="margin:0 0 18px 0; font-size:16px; color:#4b5563; line-height:1.6;">
                Hi ${inviteeName},
              </p>
              <p style="margin:0 0 18px 0; font-size:16px; color:#4b5563; line-height:1.6;">
                ${inviterName} has invited you to join the <strong>Stitches Africa Atlas</strong> dashboard. This platform provides powerful analytics and insights for our internal team.
              </p>
              ...
              <div style="background:#f9fafb; border-left:4px solid #000000; padding:16px; margin:24px 0; border-radius:4px;">
                ...
                <table style="width:100%; border-collapse:collapse;">
                  <tr>
                    <td style="padding:6px 0; font-size:15px; color:#6b7280;">Name:</td>
                    <td style="padding:6px 0; font-size:15px; color:#102a43; font-weight:600;">${inviteeName}</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td style="padding:6px 0; font-size:15px; color:#6b7280;">Access:</td>
                    <td style="padding:6px 0; font-size:15px; color:#102a43;">${roleDescription}</td>
                  </tr>
                </table>
              </div>

              <p style="margin:0 0 18px 0; font-size:16px; color:#4b5563; line-height:1.6;">
                To get started, please click the button below to accept your invitation and set up your account. This link will expire in <strong>${expiryDays} days</strong>.
              </p>
