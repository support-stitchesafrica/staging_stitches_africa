// lib/emailTemplates/customerWelcomeTemplate.ts
        ...
        <table class="container" width="640" style="max-width:640px; background:#ffffff; border-radius:12px; box-shadow:0 8px 30px rgba(22,28,37,0.08);">
          ...
          <tr>
            <td style="padding:32px 28px;">
              ...
              <p style="margin:0 0 18px 0; font-size:16px; color:#4b5563; line-height:1.6;">
                Thank you for joining <strong>Stitches Africa</strong> – your gateway to discovering unique African fashion from talented tailors and designers across the continent.
              </p>
              <p style="margin:0 0 18px 0; font-size:16px; color:#4b5563; line-height:1.6;">
              ...
              <div style="background:#f9fafb; border-left:4px solid #000000; padding:16px; margin:24px 0; border-radius:4px;">
                <p style="margin:0 0 12px 0; font-size:15px; color:#374151; font-weight:600;">What's Next?</p>
                <ul style="margin:0; padding-left:20px; color:#4b5563; font-size:15px; line-height:1.8;">
                  <li>Browse our collection of unique African fashion</li>
                  <li>Connect with talented tailors near you</li>
                  <li>Order bespoke pieces or ready-to-wear items</li>
                  <li>Save your measurements for faster ordering</li>
                </ul>
              </div>
              ...
              <p style="margin-top:32px; font-size:14px; color:#6b7280; line-height:1.6;">
                Need help? Our support team is here for you at <a href="mailto:support@stitchesafrica.com" style="color:#000000;">support@stitchesafrica.com</a>
              </p>
            </td>
          </tr>
          <tr>
