// lib/email-templates/registrationTemplate.ts
        ...
        <table class="container" width="640" style="max-width:640px; background:#ffffff; border-radius:12px; box-shadow:0 8px 30px rgba(22,28,37,0.08);">
          ...
          <tr>
            <td style="padding:28px;">
              <h1 style="margin:0 0 12px 0; font-size:22px; color:#102a43;">Welcome, ${brandName}!</h1>
              <p style="margin:0 0 18px 0; font-size:16px; color:#4b5563; line-height:1.5;">
                Thank you for registering your brand on <strong>Stitches Africa</strong>.
              </p>
              <p style="margin:0 0 18px 0; font-size:16px; color:#4b5563; line-height:1.5;">
              ...
              <a href="https://www.stitchesafrica.com/vendor/dashboard" class="button" target="_blank" rel="noopener noreferrer">
                Go to Dashboard
              </a>
