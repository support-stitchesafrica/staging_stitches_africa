// lib/emailTemplates/collectionsInvitationTemplate.ts

export interface CollectionsInvitationTemplateProps {
  inviteeName: string;
  inviterName: string;
...
/**
 * Email template for Collections team member invitations
 * Following the Marketing dashboard style for consistency
 * Requirements: 10.1, 10.2, 10.3, 10.4, 10.5
 */
export function collectionsInvitationTemplate({
  inviteeName,
  inviterName,
  role,
  invitationLink,
...
}: CollectionsInvitationTemplateProps): string {
  ...
  const roleDescriptions: Record<string, string> = {
    superadmin: "Full access to all collections features and team management",
    editor: "Create and manage product collections with canvas design tools",
    viewer: "Read-only access to view collections and team members",
  };

  const roleDescription = roleDescriptions[role] || "Access to Collections dashboard";
...
<head>
  ...
  <title>You're Invited to Join Stitches Africa Collections</title>
  <style>
        ...
        <table class="container" width="640" style="max-width:640px; background:#ffffff; border-radius:12px; box-shadow:0 8px 30px rgba(22,28,37,0.08);">
          ...
          <tr>
            <td style="padding:32px 28px;">
              <h1 style="margin:0 0 16px 0; font-size:24px; color:#102a43;">You're Invited to Join Stitches Africa Collections! 🎉</h1>
              <p style="margin:0 0 18px 0; font-size:16px; color:#4b5563; line-height:1.6;">
                Hi ${inviteeName},
              </p>
              <p style="margin:0 0 18px 0; font-size:16px; color:#4b5563; line-height:1.6;">
                ${inviterName} has invited you to join the <strong>Stitches Africa Collections</strong> dashboard. This platform will help you create, manage, and organize product collections for the marketplace.
              </p>
          ...
          <tr>
            <td style="padding:20px 28px; background:#f9fafb; border-top:1px solid #eef2f6;">
              <p style="margin:0; font-size:13px; color:#6b7280; text-align:center;">
                This is an automated message from Stitches Africa Collections
              </p>
            </td>
          </tr>
        </table>
