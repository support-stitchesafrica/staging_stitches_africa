            ...
            <td style="padding:32px 28px;">
              ...
              <div style="background:#f0f9ff; border:1px solid #bae6fd; border-radius:8px; padding:20px; margin:24px 0;">
                ...
                <p style="margin:0; font-size:14px; color:#0c4a6e;">
                  <a href="https://staging-stitches-africa.vercel.app/referral/dashboard" style="color:#0369a1; text-decoration:underline;">Check your Referral Dashboard</a> to track your points, referrals, and earnings in real time.
                </p>
              </div>
              ...
              <a href="https://staging-stitches-africa.vercel.app/referral/dashboard" class="button" target="_blank" rel="noopener noreferrer">
