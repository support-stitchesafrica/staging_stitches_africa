"""Generate PDF from auto-payout-payment-issues-and-solutions.md"""
from fpdf import FPDF
from pathlib import Path

DOCS = Path(__file__).resolve().parent.parent
md_path = DOCS / "auto-payout-payment-issues-and-solutions.md"
pdf_path = DOCS / "auto-payout-payment-issues-and-solutions.pdf"
...
mc("Stitches Africa", 10, bold=True, size=18)
mc("Payment and Auto-Payout Issues (Plain Language)", 8, bold=True, size=14)
pdf.set_text_color(80, 80, 80)
mc(
    "Document date: May 20, 2026 | Scope: Auto-payout on delivery (Next.js + Firebase Functions)",
    5,
    size=9,
)
pdf.ln(6)
